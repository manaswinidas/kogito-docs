...
* [on Quarkus](https://github.com/mswiderski/kogito-quickstarts/kogito-usertasks-custom-lifecycle-quarkus)
* [on SpringBoot](https://github.com/mswiderski/kogito-quickstarts/kogito-usertasks-custom-lifecycle-springboot)