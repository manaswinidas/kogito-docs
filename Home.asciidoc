...
and takes advantage of the good things proven in mission critical systems around the globe. At the same time
...
* *basic process* example illustrates single microservice to expose business processes as services running on
